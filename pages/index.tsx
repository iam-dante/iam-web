...
const Home = () => {
  ...
  return (
    <body className={`${enabled ? "" : "dark"}  h-screen `}>
      ...
      <div className="h-[10%] flex items-center bg-slate-100 dark:bg-zinc-800 px-16 justify-between drop-shadow-sm">
        <h1 className="text-xl font-medium dark:text-white">Brian Gasper</h1>
        <ThemeSwitch />
      </div>

      <div className="h-[90%] grid grid-cols-2 bg-white dark:bg-zinc-800">
        <div className="h-full flex flex-col justify-center items-center pl-48">
          <div className="space-y-4">
            <h1 className="font-semibold text-6xl text-sky-700">
              Hi, I'm Brian Gasper.
            </h1>
            <p className="text-4xl dark:text-white">
              A front-end developer and a UI/UX designer based in Dar es salaam,
              Tanzania
            </p>
        ...
        <div className="h-full justify-center flex items-center">
          <img src="/images/richard.jpg" className="rounded-md" />
        </div>
      </div>
    </body>
  );
